...
def generate_launch_description():
    driver_dir_left = os.path.join(
        get_package_share_directory('lslidar_driver'), 'params', 'lslidar_c32_1.yaml'
    )
    driver_dir_right = os.path.join(
        get_package_share_directory('lslidar_driver'), 'params', 'lslidar_c32_2.yaml'
    )
    rviz_dir = os.path.join(
        get_package_share_directory('lslidar_driver'), 'rviz_cfg', 'lslidar_c32.rviz'
    )
    ...
    if ros_version == b'dashing\n' or ros_version == b'eloquent\n':
        ...
        driver_node_left = LifecycleNode(
        ...
        driver_node_right = LifecycleNode(
            package='lslidar_driver',
    ...
    return LaunchDescription([driver_node_left, driver_node_right, rviz_node])
